...
\begin{frame}{Contexto e Objetivo}
  ...
  \begin{block}{Objetivo Principal}
    Comparar a acurácia (viés) e a precisão (Erro Quadrático Médio - RMSE) da Máxima Verossimilhança Restrita (REML) contra os métodos baseados no variograma (WLS e OLS) sob diferentes tamanhos amostrais ($n \in \{50, 500, 1000\}$: Pequena, Média e Grande escala).
  \end{block}
\end{frame}
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{Configuração da Simulação}
        \begin{itemize}
          ...
          \item \textbf{Tamanhos Amostrais ($n$):} $50, 500, 1000$ (Pequena, Média, Grande)
