...
\begin{frame}{Resultados Numéricos Comparativos ($N = 100$)}
  ...
  \begin{table}[h]
    ...
    \begin{tabular}{ccccccc}
      ...
      \midrule
      $n = 50$ & \textbf{REML} & Efeito Pepita ($\tau^2$) & 0.20 & 0.186 & -0.014 & \textbf{0.177} \\
      $n = 50$ & WLS & Efeito Pepita ($\tau^2$) & 0.20 & 0.287 & +0.087 & 0.257 \\
      $n = 50$ & \textbf{REML} & Alcance ($\phi$)   & 20.0 & 33.00 & +13.00 & \textbf{43.10} \\
      $n = 50$ & OLS & Alcance ($\phi$)   & 20.0 & 43.76 & +23.76 & 54.62 \\
      \midrule
      $n = 100$ & \textbf{REML} & Patamar ($\sigma^2$) & 1.00 & 1.145 & +0.145 & \textbf{0.578} \\
      $n = 100$ & OLS & Patamar ($\sigma^2$) & 1.00 & 1.376 & +0.376 & 1.133 \\
      $n = 100$ & \textbf{REML} & Alcance ($\phi$)   & 20.0 & 26.96 & +6.96  & \textbf{26.80} \\
      \midrule
      $n = 200$ & \textbf{REML} & Efeito Pepita ($\tau^2$) & 0.20 & 0.192 & -0.008 & \textbf{0.068} \\
      $n = 200$ & \textbf{REML} & Patamar ($\sigma^2$) & 1.00 & 1.002 & +0.002 & \textbf{0.357} \\
      $n = 200$ & \textbf{REML} & Alcance ($\phi$)   & 20.0 & 20.30 & +0.30  & \textbf{10.48} \\
      \bottomrule
    \end{tabular}
  \end{table}
\end{frame}
